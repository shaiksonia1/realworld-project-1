...
const DiseaseApi = () => {
  ...
  <form onSubmit={(e) => e.preventDefault()} className="relative w-[50vw]">
    <i
      className="fas fa-search absolute top-1/2 left-4 text-gray-500 text-lg transform -translate-y-1/2"
      aria-hidden="true"
    ></i>
    <input
      type="text"
